        ...
        <>
            <div className="docs-container">
                ...
                <div className="commands">
                    ...
                    <span className="command-info">No longer needs to be reset on bot updates.</span> <p>Best used in a dedicated channel for itself to keep information visible. Can only be active in a single channel.</p> <br />
